...
1. Install demo XR Interactions using same principle as in step 1, but with this url : https://github.com/De-Panther/unity-webxr-export.git?path=/Packages/webxr-interactions  
